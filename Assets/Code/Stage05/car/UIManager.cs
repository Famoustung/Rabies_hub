...
namespace TrafficRacer
{
    ...
    public class UIManager : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject mainMenu, gameMenu, gameOverMenu, selectPanel, selectHolder, carHolder , WinPanel;
        
        [SerializeField] private TextMeshPro distanceText;
        [SerializeField] private Slider distanceSlider;//ref to the text which shows the distance info
        [SerializeField] public GameObject  cameraMain,cameraGame;

        public TextMeshPro DistanceText { get { return distanceText; } } //getter for distanceText
        public Slider DistanceSlider { get { return distanceSlider; } }
