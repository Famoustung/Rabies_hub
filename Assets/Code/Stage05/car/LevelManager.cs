...
namespace TrafficRacer
{
    ...
    public class LevelManager : MonoBehaviour
    {
        ...
        private float Distance = 300; //track distance travelled
        ...
        private void Update()
        {
            ...
            if (GameManager.singeton.gameStatus == GameStatus.PLAYING)  //check if gamestatus is not PLAYING
            {
                ...
                Distance -= moveSpeed * Time.deltaTime;                                                        //update DistanceText
                UIManager.instance.DistanceText.text = string.Format("{0:0}", Distance);
                UIManager.instance.DistanceSlider.value = (distanceTravelled / 300 );
            }
        ...
        public void GameOver()                                  
        {
            ...
            UIManager.instance.uiSetactiveFalse();
